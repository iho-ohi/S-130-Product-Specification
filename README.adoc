...
= IHO S-130 Polygonal Demarcations of Global Sea Areas

image:https://github.com/metanorma/S-130-Product-Specification/actions/workflows/generate.yml/badge.svg["Build Status", link="https://github.com/metanorma/S-302-Product-Specification/actions/workflows/generate.yml"]

This document is available in its rendered forms here:

* https://iho-ohi.github.io/S-102-Product-Specification/[IHO S-130 (HTML)]

== Purpose

This is the IHO repository for developing the next edition of
the S-130 	Polygonal Demarcations of Global Sea Areas Product Specification.
...
This repository contains the source files of S-130 standards, including:
...
`sources/`::
source of the S-130 documents and models
